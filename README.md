...
album, **1.57× faster** on a 59-track playlist, in **a third of the peak
memory** — and it recovers in FLAC one geoblocked track that upstream degrades
to MP3. Method and caveats in [benchmark.MD](benchmark.MD).
